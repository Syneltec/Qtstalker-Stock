...
{
  QAction *a = new QAction(QPixmap(search_xpm), tr("Start Scan"), this);
  ...
  a = new QAction(QPixmap(stop_xpm), tr("Stop Scan"), this);
  ...
  a = new QAction(QPixmap(new_xpm), tr("New Indicator"), this);
  ...
  a = new QAction(QPixmap(edit_xpm), tr("Edit Indicator"), this);
  ...
  a = new QAction(QPixmap(delete_xpm), tr("Remove Indicator"), this);
  ...
  a = new QAction(QPixmap(save_xpm), tr("Save Results As Group"), this);
